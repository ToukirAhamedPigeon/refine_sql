...
def log_step_start(step_name):
    ...
    print(f"[{start_time.strftime('%Y-%m-%d %H:%M:%S')}] 🚀 Starting: {step_name}")
    return start_time
...
def log_step_end(step_name, start_time):
    ...
    print(f"[{end_time.strftime('%Y-%m-%d %H:%M:%S')}] ✅ Finished: {step_name} "
...
print("🧹 Cleanup complete — only results/building_database.sql kept.")
